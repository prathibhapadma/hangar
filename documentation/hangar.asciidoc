...
include::github/setup-eks-provisioning-pipeline.asciidoc[leveloffset=+4]

<<<<

include::github/setup-aks-provisioning-pipeline.asciidoc[leveloffset=+4]

<<<<

include::github/setup-deploy-pipeline.asciidoc[leveloffset=+3]
